...
const UserCard = ({user}) => {
    ...
    const handleConnectionReques = async() =>{
  ...
  return (
    <div key={user._id} className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md'>
        ...
        <div className='flex mt-4 gap-2'>
          ...
          {/* connection request */}
          <button onClick={handleConnectionReques} className='flex items-center justify-center w-16 border text-slate-500 group rounded-md cursor-pointer active:scale-95 transition'>
           {
