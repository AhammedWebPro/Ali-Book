    ...
    <div className='flex flex-col h-screen'>
      ...
      <div className='p-5 md:px-10 h-full overflow-y-scroll'>
        <div className='space-y-4 max-w-4xl mx-auto'>
          {
            messages.toSorted((a, b) => new Date(a.createdAt) - new Date(b.createdAt)).map((message, indedx) => (
              <div className={`flex flex-col ${message.to_user_id !== user._id ? `items-start` : "items-end"}`} key={indedx}>
      ...
      <div className='px-4'>
        <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5 '>
          <input type="text" className='flex-1 outline-none text-slate-700 ' placeholder='type a messge...'
