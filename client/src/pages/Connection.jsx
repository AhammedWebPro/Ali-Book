...
import { User, UserPlus, UserCheck, UserRoundPen, MessagesSquare } from 'lucide-react'
  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        {/* title */}
          <div className='mb-8'>
          <h1 className='text-3xl font-bold text-slate-900 mb-2'>Connnections</h1>
          <p className='text-slate-600'>Mange your network and discover neew connectos</p>
            ...
            <div className='flex max-sm:flex-col gap-2 mt-4'>
...

              {
                currentTab === 'Connections' && (
                  <button onClick={() => navigate(`/messages/${user._id}`)} className='w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-500  active:scale-95 transition cursor-pointer flex items-center justify-center gap-2'>
